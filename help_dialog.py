...
class HelpDialog(wx.Dialog):
    def __init__(self, parent):
        ...
        <p>Select your midi ports and device ID. Press the "Connect" button to connect to the E4.</p>
        <br/><br/>
        <img src="images/open_ports.png" width="386" height = "193"/>
        <br/><br/><br/><br/>
        <ul>
            The E4 should connect immediately and a popup will confirm your E4 Model and EOS version.
        </ul>
        <br/><br/>
        ...
        <p>
            Enter the Preset Number you want to retrieve and click the "Get Preset" button.
        ...
        <p>
            The E4 is live updated as you edit the parameters in the E4 Open Interface. To save your edits to the preset, save the preset on the E4.
        </p>
        <br/><br/>
        ...
        <br/><br/><br/><br/>
        <h2>4. Bonus Feature 1... A Metronome!</h2>
        <p>
            Just because.
        </p>
        <br/><br/>
        <img src="images/metronome.png" width="560" height = "83"/>
        <br/><br/><br/><br/>
        <h2>4. Bonus Feature 2... A CC controller panel with 128 CC controllers!</h2>
        <p>
            I mean, why not? Keep your CC controllers in order by giving them custom names. The names are saved and are automatically restored.
        </p>
        <br/><br/>
        <img src="images/cc.png" width="560" height = "392"/>
        <br/><br/><br/><br/>
        </body>
        </html>
        """
